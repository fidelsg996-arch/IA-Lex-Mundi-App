const ModuloPhase = ({ curso, modulo, onBack, onSeleccionarLeccion, estaCompletada }) => {
  ...
  return (
    <div className="px-4 py-3">
      <button onClick={onBack} className="mb-4 text-amber-600 font-semibold flex items-center gap-1">
        <span className="material-symbols-outlined text-sm">arrow_back</span> Volver al curso
      </button>
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div className="p-4 space-y-2">
          {leccionesLista.map((leccion, idx) => {
            const completada = estaCompletada(curso.id, modulo.id, leccion.id);
            return (
